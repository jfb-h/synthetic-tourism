...
= Conclusion
This study examines the impact of exceptional architecture on urban tourism by analyzing the inauguration of the Elbphilharmonie in Hamburg. Using the synthetic control method, we construct a data-driven counterfactual to assess whether the building’s opening had a causal effect on overnight stays that would not have occurred otherwise. The findings provide robust evidence that the Elbphilharmonie generated an estimated 13 million additional overnight stays in the seven and a half years following its opening in 2017. To contextualize these findings, a rough projection based on the average on-site travel expenses of €129 per person per day in 2023 @hamburgtourismus2024 suggests that this translates into approximately €1.7 billion in additional touristic spending by overnight visitors.

By applying the synthetic control method, we offer a replicable framework for enhancing causal inference that can be adapted to evaluate other place-based interventions across different regions and time periods and responds to ongoing calls for greater methodological rigor in tourism research @zopiatis2021. Furthermore, we contribute empirical clarity to a field often marked by mixed results and context-specific contingencies. Our findings demonstrate that a single, exceptional architectural intervention can exert measurable and lasting effects on local tourism flows, independent of broader regional developments. More broadly, the results contribute to the growing literature on urban megaprojects, which have become key instruments of economic development in both industrialized and emerging economies @hassink2025a[p. 255]. While some scholars caution that the tourism effects of landmark architecture may be short-lived, the Elbphilharmonie appears to defy this pattern, showing persistent impact nearly eight years after its opening.
