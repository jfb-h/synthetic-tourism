...
Architecturally integrated in/on the brick corpus of a former cocoa warehouse in Hamburg’s harbor area, it is adjacent to the historic warehouse complex and UNESCO World Heritage Site ‘Speicherstadt and Kontorhaus District with Chilehaus’ (in the following: Speicherstadt) @heuer2022 (see Figure 1). #highlight[Situated at HafenCity's western edge, the Elbphilharmonie is within walking distance of major attractions such as the Speicherstadt, the Landungsbrücken waterfront, and Hamburg’s theater musical dome across the river, forming part of a geographical concentration of cultural sites typical of urban tourism areas @ashworth2011.]
...
A final potential source of confounding is the designation of the Speicherstadt, located in direct proximity to the Elbphilharmonie, as a World Heritage Site in 2015. This carries the risk of misattributing a potential World Heritage related effect on overnight stays to the Elbphilharmonie. To assess the extent to which the World Heritage nomination might have generated an attention pattern similar to that of the Elbphilharmonie, we rely on Google Trends data @googletrends. @figure-google presents the search indices for the terms "Elbphilharmonie" and "Speicherstadt" and shows a clear difference in visibility: while there is a notable spike around the Elbphilharmonie's opening, search behaviour reacts only minimally to the World Heritage nomination. Although Google Trends measures search interest rather than actual visitation, prior research has shown that it is a reasonable proxy for destination interest @dinis2019 @onder2017 @botha2024. The observed difference supports the interpretation that the Elbphilharmonie, rather than the World Heritage designation, primarily drove the increase in interest relevant to Hamburg's tourism.]
...
= Discussion
#highlight[This study examines the local impact of exceptional architecture on tourism by analyzing the inauguration of the Elbphilharmonie in Hamburg. Using the synthetic control method, we constructed a data-driven counterfactual scenario to assess whether the construction of the Elbphilharmonie lead to an increase in overnight stays that would not have occurred otherwise. The COVID-19 pandemic led to uneven recovery paths across European destinations, which challenges traditional comparative methods. However, our synthetic Hamburg, composed of 97 percent German cities and 3 percent Amsterdam, provides a stable benchmark with closely aligned pre-treatment dynamics. Our analysis provides evidence that the Elbphilharmonie generated an estimated 13 million additional overnight stays in the seven and a half years following its opening in 2017.

To contextualize these findings, an illustrative projection based on the average on-site travel expenses of €129 per person per day in 2023 @hamburgtourismus2024 suggests approximately €1.7 billion in additional touristic spending by overnight visitors. Although this simple calculation is not a formal economic model, it provides a rough indication that, despite the at-the-time heavily criticized project cost of around €870 million @maak2015, the expense could have been broadly offset at the macroeconomic level within a relatively short period. Although our analysis is in line with the Elbphilharmonie having been an economic success for the city of Hamburg, it doesn't indicate that this need be the case for all architectural lighthouse projects. Indeed, many case studies outline how such projects failed to meet economic or cultural expectations, such as the PalaFuksas in Turino @vanolo2022, the Phæno in Wolfsburg @alaily-mattar2019, or the Oscar Niemeyer Centre in Avilés @somozamedina2019. 

Furthermore, exceptional architectural projects can evoke complex social effects on neighboring neighborhoods beyond their economic influence. These may include changes in the local housing market, shifts in resident demographics, and gentrification, as noted in earlier research @balke2018 @novy2019. Additionally, an increased volume of tourism can lead to overtourism that exceeds local social capacities and disrupts residents' everyday social life @namberger2021. Although examining these effects falls outside the scope of this empirical analysis, recognizing and investigating them is important for a comprehensive understanding of the urban transformation that exceptional architecture can trigger. Finally, there is still a significant amount of variation in the estimation which likely renders the estimate of the actual effect rather imprecise; accordingly, care should be taken in its interpretation.]
...
Future research should aim to reconcile economic effects with their contribution to and interaction with urban social structure and culture. Beyond economic impact, megaprojects are frequently discussed critically: they can reflect and reinforce power structures, serving the symbolic and material interests of dominant actors, or legitimize neoliberal agendas where the spectacle of innovation conceals exclusionary logics @novy2019 @balke2018. In contrast, other recent work suggests that such buildings may have positive social effects by serving as ‘field-configuring places’ @capron2024 or sites of institutional change @dreher2022. Comparative case studies investigating the mechanisms underlying the success or failure of these projects would make for a valuable contribution to this field. Finally, beyond economic impact, there are also social and cultural aspects to exceptional architecture, which are frequently discussed critically: Megaprojects can reflect and reinforce power structures, serving the symbolic and material interests of dominant actors.
