...
@figure-robustness (b) shows the result of running the synthetic control procedure with the intervention advanced from 2017 to 2010: The synthetic series does not significantly diverge from the observed series between the placebo intervention and the actual intervention, but does still recover the divergence observed after the opening of the Elbphilharmonie in 2017. #highlight[Although the COVID-19 pandemic caused uneven recovery paths across European destinations, the synthetic control method’s focus on similar pre-intervention trends ensures the validity of our counterfactual. Our synthetic Hamburg, made up of 97% German cities and 3% Amsterdam, offers a stable benchmark for comparison. Additionally, placebo analyses show that no similar divergences occur among control units after 2017, highlighting the robustness of our estimated Elbphilharmonie effect despite pandemic disruptions.]
...
The findings are robust in the face of both case-based and temporal placebo studies. #highlight[To contextualize these findings, an illustrative projection based on the average on-site travel expenses of €129 per person per day in 2023 @hamburgtourismus2024 suggests approximately €1.7 billion in additional touristic spending by overnight visitors. Although this simple calculation is not a formal economic model, it provides a rough indication that, despite the at-the-time heavily criticized project cost of around €870 million @maak2015, the expense could have been broadly offset at the macroeconomic level within a relatively short period.]
