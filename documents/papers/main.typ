...
Its inauguration has been linked to amplified tourism, a revitalized local economy, and an elevated cultural reputation @alaily-mattar2018b @plaza2006 @plaza2009. However, the effectiveness of exceptional architecture in attracting tourists remains a subject of disagreement. #highlight[However, the effectiveness of exceptional architecture in attracting tourists remains a subject of disagreement. According to#cite(<dreher2020>, form: "prose"), some studies emphasize the positive and lasting economic and tourism impacts, while others suggest that these effects are only short-lived and do not achieve the anticipated outcomes (p. 442).]
...
#highlight[Our study builds on this assumption by using the Elbphilharmonie in Hamburg as a case study to explore the forward linkage effects @gelman2013 @hiller1998 of its inauguration to address the research question of how exceptional architecture can influence overnight stays in the local tourism sector.]
...
Architecturally integrated in/on the brick corpus of a former cocoa warehouse in Hamburg’s harbor area, it is adjacent to the historic warehouse complex and UNESCO World Heritage Site ‘Speicherstadt’ @heuer2022 (see Figure 1). #highlight[Situated at HafenCity's western edge, the Elbphilharmonie is within walking distance of major attractions like Miniatur Wunderland, the Landungsbrücken waterfront, and Hamburg’s theaters across the river, forming part of a geographical concentration nof cultural sites typical of urban tourism areas @ashworth2011.]
...
#highlight[The COVID-19 pandemic led to uneven recovery paths across European destinations. The synthetic control method constructs the counterfactual solely based on similarity in pre-intervention trends, ensuring the credibility of our comparison. Our synthetic Hamburg, composed of 97 percent German cities and 3 percent Amsterdam, provides a stable benchmark with closely aligned pre-treatment dynamics. Additionally, placebo analyses show no comparable post-2017 divergences among control units, highlighting the robustness of our estimated Elbphilharmonie effect despite pandemic-related factors. 
A final potential source of confounding is the designation of the _Speicherstadt_, located in direct proximity to the Elbphilharmonie, as a World Heritage Site in 2015. This carries the risk of misattributing a potential World Heritage related effect on overnight stays to the Elbphilharmonie. Since this designation represents a potential idiosyncratic shock to the treated unit and occurred at a similar time, such misattribution would not necessarily be captured by the synthetic control method. To assess the extent to which the World Heritage nomination might have generated an attention pattern similar to that of the Elbphilharmonie, we rely on Google Trends data @googletrends. @figure-google presents the search indices for the terms "Elbphilharmonie" and "Speicherstadt" and shows a clear difference in visibility: while there is a notable spike around the Elbphilharmonie's opening, search behaviour reacts only minimally to the World Heritage nomination. Although Google Trends measures search interest rather than actual visitation, and although its construct therefore differs from tourism flows, prior research has shown that it is a reasonable proxy for destination interest and an effective tool for forecasting tourism demand @dinis2019 @onder2017 @botha2024. In this context, we use Google Trends not to measure visitation directly but to detect relative shifts in public attention, and the observed difference supports the interpretation that the Elbphilharmonie, rather than the World Heritage designation, primarily drove the increase in interest relevant to Hamburg's tourism.]
...
The findings are robust in the face of both case-based and temporal placebo studies. #highlight[To contextualize these findings, an illustrative projection based on the average on-site travel expenses of €129 per person per day in 2023 @hamburgtourismus2024 suggests approximately €1.7 billion in additional touristic spending by overnight visitors. Although this simple calculation is not a formal economic model, it provides a rough indication that, despite the at-the-time heavily criticized project cost of around €870 million @maak2015, the expense could have been broadly offset at the macroeconomic level within a relatively short period. Therefore, this study contributes to the literature on the effects of exceptional architecture by providing causal evidence of a lasting tourism impact, supporting earlier qualitative findings and offering empirical clarity to a field often characterized by mixed results.]
Although our analysis is in line with the Elbphilharmonie having been an economic success for the city of Hamburg, it doesn't indicate that this need be the case for all architectural lighthouse projects. #highlight[Practically, the results indicate that high-profile architectural projects can produce lasting tourism benefits when incorporated into broader urban strategies, although outcomes depend on the specific local context @alaily-mattar2020a.]
Indeed many case studies outline how such projects failed to meet economic or cultural expectations, such as the PalaFuksas in Turino @vanolo2022, the Phæno in Wolfsburg @alaily-mattar2019, or the Oscar Niemeyer Centre in Avilés @somozamedina2019. #highlight[Beyond their economic impact, exceptional architectural projects can also produce complex social effects on nearby neighborhoods. These effects may include changes in the local housing market, shifts in resident demographics, and gentrification processes, as discussed in earlier work @balke2018 @novy2019. Although studying these effects is outside the scope of this empirical analysis, acknowledging and exploring them is important for a comprehensive understanding of urban transformation.]
...
They may also be used to legitimize neoliberal agendas and promote 'post-political' forms of urban governance, where the spectacle of innovation and strategic planning conceals the exclusionary and commercial logics underlying development @novy2019 @balke2018 @hausler2024 @bassols2019.
