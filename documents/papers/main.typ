...
#figure(
  ...
  scope: "parent",
  placement: top,
  caption: [(a) Elbphilharmonie Hamburg with its wave-shaped glass façade ©T.Rätzke (b) View over the Speicherstadt ©T.Rätzke (c) Architecture and construction details ©Herzog&de Meuron (d) Brick corpus of the cocoa warehouse in 1967 ©Zoch. #highlight[Source: elbphilharmonie&laeiszhalle] (e) Location of the Elbphilharmonie and nearby attractions. Modified base map from #cite(<freieundhansestadthamburglgv2024>, form: "prose")]
)
...
= Discussion
#highlight[This study examines the local impact of exceptional architecture on tourism by analyzing the inauguration of the Elbphilharmonie in Hamburg. Using the synthetic control method, we constructed a data-driven counterfactual scenario to assess whether the construction of the Elbphilharmonie lead to an increase in overnight stays that would not have occurred otherwise. Our analysis provides evidence that the Elbphilharmonie generated an estimated 13 million additional overnight stays in the seven and a half years following its opening in 2017. To contextualize these findings, an illustrative projection based on the average on-site travel expenses of €129 per person per day in 2023 @hamburgtourismus2024 suggests approximately €1.7 billion in additional touristic spending by overnight visitors. Although this simple calculation is not a formal economic model, it provides a rough indication that, despite the at-the-time heavily criticized project cost of around €870 million @maak2015, the expense could have been broadly offset at the macroeconomic level within a relatively short period. Although our analysis is in line with the Elbphilharmonie having been an economic success for the city of Hamburg, it doesn't indicate that this need be the case for all architectural lighthouse projects. Indeed, many case studies outline how such projects failed to meet economic or cultural expectations, such as the PalaFuksas in Turino @vanolo2022, the Phæno in Wolfsburg @alaily-mattar2019, or the Oscar Niemeyer Centre in Avilés @somozamedina2019. 

Methodwise, the donor pool is almost entirely composed of German cities, apart from Amsterdam with a weight of 0.03, which limits cross-country confounding from travel and policy differences. Although some variation across federal states existed, Germany followed a broadly coordinated pandemic policy timeline (e.g., the March 2020 contact ban, the mid-December 2020 winter tightening, and the April 2021 federal emergency brake). The main federal decisions were implemented nearly simultaneously across states, so the German donor cities, which account for 0.97 of the synthetic weight, experienced largely comparable policy timing. This, together with the synthetic control method’s reliance on pre-treatment trajectories, ensures that post-2017 deviations are identified primarily from the opening of the Elbphilharmonie rather than from heterogeneous pandemic recovery paths. 
