...
#highlight[However, while this study reports a major tourism impact, the findings remain subject to limitations regarding donor pool sensitivity and the potential for pandemic-induced trends to influence the post-2020 estimates. As detailed in the discussion, these factors necessitate careful contextualization of the counterfactual trajectory and highlight the need for future research studying cases that were not affected by the covid pandemic and thus allow for more flexible donor pool construction.]
