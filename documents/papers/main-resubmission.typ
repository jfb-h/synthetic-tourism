...
#show: template.with(
  ...
  //This is an original manuscript of an article published by Taylor & Francis in Tourism Planning & Development [date of publication], available online: http://dx.doi.org/10.1080/21568316.2026.2649241
...
Our empirical findings indicate that the Elbphilharmonie has had a sustained positive impact on tourism development in Hamburg, resulting in an additional 18 million (7%) overnight stays within eight and a half years since its opening. 
In the following sections, we will first outline the theoretical and empirical discussions regarding the influence of exceptional architecture on tourist attractiveness, while also addressing the methodological challenges associated with identifying causal effects. Section 3 presents the Elbphilharmonie as a case study, followed by a description of the data and the synthetic control method in Section 4. We then report the empirical results in Section 5, which includes the estimated “Elbphilharmonie Effect” and its regional implications for tourism, as well as robustness checks to validate our findings. In Section 6, we discuss our results, before concluding in Section 7 with broader implications and an outlook for further lines of research.
...
= The Elbphilharmonie as a case study
...
Designed by internationally renowned architects Herzog & de Meuron, who also created the Tate Modern in London and the 'Bird's Nest' Olympic Stadium in Beijing, the building is situated in a prominent location @alaily-mattar2018, and - on par with comparable iconic architectural landmarks @ghalejough2025 - has sparked extensive media coverage.
...
The German units capture national touristic trends and mostly uniform policy responses during the pandemic, while the international peers account for tourism dynamics specific to Northern European maritime hubs. Rotterdam, in particular, serves as a primary structural analog due to its shared identity as a major harbor city transitioning toward a culture-driven waterfront economy. Together, the international units represent recognized functional and economic benchmarks for Hamburg @europeancommission.jointresearchcentre.2023a. Within the city break market, these destinations offer a comparable urban image that appeals to the creative and cosmopolitan consuming classes @maitland2010, and so function as potential spatial substitutes for visitors @cakar2025. This focused pool minimizes cross-country confounding variables, such as diverging travel restrictions, which would otherwise introduce noise into the synthetic series during the COVID-19 period.
