...
#figure(
  ...
  scope: "parent",
  placement: top,
  caption: [(a) Elbphilharmonie Hamburg with its wave-shaped glass façade ©T.Rätzke (b) View over the Speicherstadt ©T.Rätzke (c) Architecture and construction details ©Herzog&de Meuron (d) Brick corpus of the cocoa warehouse in 1967 ©Zoch. #highlight[Source: #cite(<elbphilharmonie2024>, form: "prose")] (e) Location of the Elbphilharmonie and nearby attractions. Modified base map from #cite(<freieundhansestadthamburglgv2024>, form: "prose")]
)
